...
import { ProductService, GetResponseProducts } from 'src/app/services/product.service';
...
export class ProductListComponent implements OnInit {
  ...
  handleSearchProducts() {
    ...
    if (keyword != null) {
      ...
      this.productService.searchProductPaginate(this.pageNumber - 1, this.pageSize, keyword).subscribe(response => {
